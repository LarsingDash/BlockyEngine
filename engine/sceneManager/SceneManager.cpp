...
SceneManager::SceneManager() :
	...
	TypeProperties p(COLLIDER, true, false, {20, 2}, 1000, 0, 10, false); //todo: move in component
	...
	auto& boxr1 = child2.AddComponent<BoxRigidBody>("Box_Collider_Red_Rigid", true, false, p.velocity,
	...
	auto& circler1 = child3.AddComponent<CircleRigidBody>("Circle_Collider_Red_Rigid", false, true, p.velocity,
	                                                      p.rotationVelocity, p.angularResistance, p.linearResistance,
	                                                      p.gravityEnabled, r);

	p = TypeProperties(RIGIDBODY, true, false, {-10, -25}, 10000, 0, 0, true); //todo: move in component
	...
	auto& boxr2 = child12.AddComponent<BoxRigidBody>("Box_Collider_Green_Rigid", false, true, p.velocity,
	                                                 p.rotationVelocity, p.angularResistance, p.linearResistance,
	                                                 p.gravityEnabled, w, h);
	...
	auto& circler2 = child13.AddComponent<CircleRigidBody>("Circle_Collider_Green_Rigid", true, false, p.velocity,
	                                                       p.rotationVelocity, p.angularResistance, p.linearResistance,
	                                                       p.gravityEnabled, r);
