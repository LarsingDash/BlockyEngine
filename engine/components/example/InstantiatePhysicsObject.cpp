...
InstantiatePhysicsObject::InstantiatePhysicsObject(GameObject *gameObject, const char *tag): Component(gameObject, tag), container(nullptr) {
    ...
    physicsGO->AddComponent<BoxRigidBody>("BoxColl", properties, 32,32);
}

InstantiatePhysicsObject::~InstantiatePhysicsObject() = default;

InstantiatePhysicsObject::InstantiatePhysicsObject(const InstantiatePhysicsObject &other): Component(other), physicsGO(std::make_unique<GameObject>(*other.physicsGO)), container(other.container){
}
